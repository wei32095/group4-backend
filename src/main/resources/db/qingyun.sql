...
CREATE TABLE `user` (
                        ...
                        `openid` VARCHAR(100) UNIQUE COMMENT '微信小程序 openid',
...
CREATE TABLE `course` (
                          ...
                          `user_info` VARCHAR(100) NOT NULL COMMENT '教师信息',
...
CREATE TABLE `question` (
                            ...
                            `per_score` INT NOT NULL COMMENT '每题分值',
...
CREATE TABLE `subject_submit` (
                                  ...
                                  `subject_heading` TEXT NOT NULL COMMENT '主观题题目',
                                  ...
                                  `submit_status` VARCHAR(20) DEFAULT 'PENDING' COMMENT '批改状态：PENDING-待批改，GRADED-已批改',
                                  `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '学生提交时间',
                                  `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '老师批改时间',
                                  INDEX idx_assignment_id (assignment_id),
...
CREATE TABLE `object_submit` (
                                 ...
                                 `assignment_id` BIGINT NOT NULL COMMENT '作业ID',
                                 `user_name` VARCHAR(50) NOT NULL COMMENT '学生姓名',
                                 `object_heading` TEXT NOT NULL COMMENT '客观题题目',
...
CREATE TABLE `class_vote` (
                              ...
                              `duration` INT DEFAULT 120 COMMENT '投票时长（秒）',
...
CREATE TABLE `shop_item` (
                             ...
                             `growth_value` INT DEFAULT 10 COMMENT '使用后可提升的生长值',
                             `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
