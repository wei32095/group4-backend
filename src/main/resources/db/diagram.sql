...
CREATE TABLE `class` (
                         ...
                         CONSTRAINT `fk_class_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `course_resource` (
                                   ...
                                   CONSTRAINT `fk_course_resource_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `question` (
                            ...
                            CONSTRAINT `fk_question_assignment` FOREIGN KEY (`assignment_id`) REFERENCES `assignment` (`id`)
...
CREATE TABLE `object_submit` (
                                 ...
                                 KEY `idx_user_id` (`user_id`),
                                 CONSTRAINT `fk_object_submit_assignment` FOREIGN KEY (`assignment_id`) REFERENCES `assignment` (`id`),
                                 CONSTRAINT `fk_object_submit_question` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`),
                                 CONSTRAINT `fk_object_submit_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `subject_submit` (
                                  ...
                                  CONSTRAINT `fk_subject_submit_assignment` FOREIGN KEY (`assignment_id`) REFERENCES `assignment` (`id`),
                                  CONSTRAINT `fk_subject_submit_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
                                  CONSTRAINT `fk_subject_submit_question` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`)
...
CREATE TABLE `class_check` (
                               ...
                               KEY `idx_user_id` (`user_id`),
                               CONSTRAINT `fk_class_check_class` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`),
                               CONSTRAINT `fk_class_check_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `class_vote` (
                              ...
                              PRIMARY KEY (`id`),
                              KEY `idx_class_id` (`class_id`),
                              CONSTRAINT `fk_class_vote_class` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`)
...
CREATE TABLE `vote_record` (
                               ...
                               KEY `idx_user_id` (`user_id`),
                               CONSTRAINT `fk_vote_record_vote` FOREIGN KEY (`vote_id`) REFERENCES `class_vote` (`id`),
                               CONSTRAINT `fk_vote_record_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `class_chat` (
                              ...
                              KEY `idx_class_id` (`class_id`),
                              KEY `idx_user_id` (`user_id`),
                              CONSTRAINT `fk_class_chat_class` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`),
                              CONSTRAINT `fk_class_chat_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `study_room` (
                              ...
                              CONSTRAINT `fk_study_room_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `flower` (
                          ...
                          CONSTRAINT `fk_flower_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
                          CONSTRAINT `fk_flower_seed` FOREIGN KEY (`seed_id`) REFERENCES `seed` (`id`)
...
CREATE TABLE `student_analysis` (
                                    ...
                                    KEY `idx_user_id` (`user_id`),
                                    CONSTRAINT `fk_student_analysis_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `course_problem` (
                                  ...
                                  KEY `idx_course_id` (`course_id`),
                                  KEY `idx_user_id` (`user_id`),
                                  CONSTRAINT `fk_course_problem_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`),
                                  CONSTRAINT `fk_course_problem_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `course_problem_reply` (
                                        ...
                                        KEY `idx_user_id` (`user_id`),
                                        CONSTRAINT `fk_course_problem_reply_problem` FOREIGN KEY (`problem_id`) REFERENCES `course_problem` (`id`),
                                        CONSTRAINT `fk_course_problem_reply_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
CREATE TABLE `recommendation` (
                                  ...
                                  `weak_point_id` BIGINT NOT NULL COMMENT '关联薄弱知识点ID',
                                  `question` JSON NOT NULL COMMENT '推荐题目（单个JSON对象）',
                                  `is_correct` TINYINT DEFAULT 0 COMMENT '状态：0-未答，1-正确，2-错误',
                                  INDEX idx_user_id (user_id),
                                  INDEX idx_assignment_id (assignment_id),
                                  INDEX idx_weak_point_id (weak_point_id),
                                  CONSTRAINT `fk_recommendation_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
                                  CONSTRAINT `fk_recommendation_assignment` FOREIGN KEY (`assignment_id`) REFERENCES `assignment` (`id`),
                                  CONSTRAINT `fk_recommendation_weak_point` FOREIGN KEY (`weak_point_id`) REFERENCES `assignment_weak_points` (`id`)
...
CREATE TABLE `assignment_weak_points` (
                                          ...
                                          INDEX idx_assignment_id (assignment_id),
                                          INDEX idx_user_id (user_id),
                                          CONSTRAINT `fk_weak_points_assignment` FOREIGN KEY (`assignment_id`) REFERENCES `assignment` (`id`),
                                          CONSTRAINT `fk_weak_points_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
